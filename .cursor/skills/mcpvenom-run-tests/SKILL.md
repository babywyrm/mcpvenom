---
name: mcpvenom-run-tests
description: >-
  Run mcpvenom's test suite, interpret failures, and fix issues. Use when
  running tests, debugging test failures, or verifying changes in mcpvenom.
---
